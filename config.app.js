const appConfig = {
  ...
  aggregates: [
    ...
    {
      name: 'Application',
      commands: 'common/aggregates/application.commands.js',
      projection: 'common/aggregates/application.projection.js'
    }
  ],
  readModels: [
    {
  ...
  viewModels: [
    ...
    },
    {
      ...
      projection: 'common/view-models/application.projection.js'
    }
  ],
  redux: {
